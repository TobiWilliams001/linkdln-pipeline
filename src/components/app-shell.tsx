      ...
      >
        ...
        >
          ...
          <button
            ...
            className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg text-zinc-400 transition-colors hover:bg-zinc-950/4 hover:text-zinc-950 dark:text-zinc-500 dark:hover:bg-white/5 dark:hover:text-zinc-50"
          >
              ...
              <Link
                ...
                className={`flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm font-medium transition-colors ${
                  ...
                  active
                    ...
                    : "text-zinc-600 hover:bg-zinc-950/4 hover:text-zinc-950 dark:text-zinc-400 dark:hover:bg-white/5 dark:hover:text-zinc-50"
                }`}
              >
        ...
        <div ref={menuRef} className="relative border-t border-zinc-950/10 pt-3 dark:border-white/10">
          ...
          <button
            ...
            className={`flex w-full items-center gap-2 rounded-lg px-2 py-2 text-left transition-colors hover:bg-zinc-950/4 dark:hover:bg-white/5 ${
              collapsed ? "justify-center" : ""
            }`}
          >
